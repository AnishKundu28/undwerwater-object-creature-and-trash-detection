...
# === CONFIGURATION ===
MODEL_PATH = r"D:\Projects\UnderWater Creature+Trash Detection\underwater-trash-detection\underwater_trash_detection\training_run\weights\best.pt"  # your uploaded model
VIDEO_PATH = r"D:\Projects\UnderWater Creature+Trash Detection\underwater-trash-detection\2.mp4"  # or None for webcam
CONF_THRESHOLD = 0.45
# ======================
